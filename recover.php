                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <br> <?php display_message();?>
                            <!-- img src="img/lock-png-circle-g.png" alt="circle lock" height="100" width="100" -->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-xs-6">
                                        <input type="reset" name="cancel-submit" id="cencel-submit" tabindex="2"
